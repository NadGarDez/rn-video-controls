...
export default class VideoPlayer extends Component {
  ...
  constructor(props) {
    ...
    this.events = {
      ...
      onPressPip: this.props.onPressPip,
      onRestoreForeground: this.props.onRestoreForeground ?? null
    };
  ...
  renderTopControls() {
    ...
    const pip =  this.props.disablePictureInPicture
    ? null
    : this.renderPictureInPictureButton()
